...
| `docs/operations/monitoring.md` | How failures get noticed: the triage table, probe policy and inventory, CronJob deadlines, the backup verification gates, the healthchecks.io checks that remain and how to list them live, the twelve uptime-kuma push monitors, the disclosure rules for both, and what none of it catches |
